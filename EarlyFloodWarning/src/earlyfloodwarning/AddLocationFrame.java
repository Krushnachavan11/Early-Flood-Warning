...
public class AddLocationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(440, 130, 479, 350);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/earlyfloodwarning/20.jpg"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(0, 0, 1370, 690);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            int srno=new SerialNumber().getSerialNumber();
            AddLocation al=new AddLocation();
            if(al.getAddLocation(srno,area, ip))
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddLocationFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddLocationFrame().setVisible(true);
            }
        });
    }
